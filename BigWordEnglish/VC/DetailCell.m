...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        wordLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 5, WIDTH_FRAME - 170, 20)];
        ...
        contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 25, WIDTH_FRAME - 170, 45)];
        ...
        levelLabel = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH_FRAME - 111, 0, 40, 70)];
        ...
        soundButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH_FRAME - 65, 27, 18, 17)];
        ...
        bookmarkButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH_FRAME - 35, 27, 18, 17)];
